...
const ModalInputDocument: React.FC<ModalInputDocumentProps> = ({
  proposal,
}) => {
    ...
    try {
      ...
      if (res.ok) {
        await Swal.fire({
          icon: "success",
          title: "Berhasil!",
          text: "Berhasil mengupload berkas!",
        ...
        await Swal.fire({
          icon: "error",
          title: "Gagal!",
          text: "Gagal mengupload berkas: " + result.message,
...
export default ModalInputDocument;
