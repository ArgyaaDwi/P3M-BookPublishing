...
import DetailPublisher from "../components/DetailPublisher";
export default function PublisherDetailPage() {
  ...
  const [breadcrumbItems, setBreadcrumbItems] = useState([
    ...
    { name: "Loading...", url: `/admin/publisher/${id}` },
  ]);
  useEffect(() => {
      ...
      try {
        ...
        if (result.status === "success") {
          ...
          setBreadcrumbItems([
            { name: "Dashboard", url: "/admin/dashboard" },
            { name: "Penerbit", url: "/admin/publisher" },
            { name: result.data.name, url: `/admin/publisher/${id}` },
          ]);
        } else {
  ...
  return (
    <div>
      <Breadcrumb title="Detail Penerbit" breadcrumbItems={breadcrumbItems} />
