...
const RevisionPaymentModal: React.FC<PaymentModalProps> = ({ invoice }) => {
  ...
  return (
    <div>
      <button
        className="bg-orange-400 p-2 rounded-lg text-white hover:bg-orange-600 hover:text-white transition-all duration-300  flex items-center gap-2"
